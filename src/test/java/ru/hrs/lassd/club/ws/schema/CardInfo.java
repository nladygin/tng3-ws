...
@XmlType(name = "CardInfo", namespace = "http://www.hrs.ru/clubng/ws/common/types", propOrder = {
    "cardType",
    "number"
})
public class CardInfo {
    ...
    @XmlElement(name = "Number", namespace = "http://www.hrs.ru/clubng/ws/common/types", required = true)
