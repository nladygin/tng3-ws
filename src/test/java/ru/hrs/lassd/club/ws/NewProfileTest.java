...
public class NewProfileTest extends BaseTest {


    @Test @Ignore("need to fix endpoint")
    public void createNewProfile() throws DatatypeConfigurationException {
        ...
        NewProfileResponse response = newProfileAction.createProfile(
                profile,
                data.siteId
        );
        newProfileAction.checkResultStatus(response, ResultStatusFlag.SUCCESS);
    }
    ...
    @Autowired private NewProfileAction newProfileAction;
