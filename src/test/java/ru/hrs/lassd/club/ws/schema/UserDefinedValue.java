...
@XmlType(name = "UserDefinedValue", namespace = "http://htng.org/PWS/2008A/SingleGuestItinerary/Common/Types", propOrder = {
    "characterValue",
    "dateValue",
    "numericValue"
})
public class UserDefinedValue {
    ...
    @XmlElement(name = "CharacterValue", namespace = "http://htng.org/PWS/2008A/SingleGuestItinerary/Common/Types")
    protected String characterValue;
    @XmlElement(name = "DateValue", namespace = "http://htng.org/PWS/2008A/SingleGuestItinerary/Common/Types")
    protected XMLGregorianCalendar dateValue;
    @XmlElement(name = "NumericValue", namespace = "http://htng.org/PWS/2008A/SingleGuestItinerary/Common/Types")
